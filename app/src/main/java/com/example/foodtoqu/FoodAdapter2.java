...
public class FoodAdapter2 extends RecyclerView.Adapter<FoodAdapter2.FoodViewHolder> {
    ...
    public FoodAdapter2(Context context, List<Food3> foodList) {
    ...
    @Override
    public void onBindViewHolder(@NonNull FoodAdapter2.FoodViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, FoodDetailActivityU.class);
    ...
    public void setFoods(List<Food3> filteredList) {
